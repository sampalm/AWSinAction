...
(function ($) {
	...
	// User pool
	var poolData = {
		UserPoolId: 'us-east-1_gX1NfpTzE', // Your user pool id here
		ClientId: '6edscs0tt7iim45v54465v0f2p' // Your app client id here
	};

	// Your identity pool id here
	var identityPoolId = "us-east-1:1d2e3484-40f3-46d4-bbc0-88a8dcd69e32"

	// Cognito Sync store name
	var cognitoDatasetName = "samapp-users";
	...
	function createCredentials(idToken) {
		AWS.config.credentials = new AWS.CognitoIdentityCredentials({
			...
			Logins: {
				...
				'cognito-idp.us-east-1.amazonaws.com/us-east-1_gX1NfpTzE': idToken
			}
		});
	...
	function createObject() {
		if (cognitoUser != null) {
			...
			identityId = AWS.config.credentials.identityId;
			var prefix = 'cognito/samapp/' + identityId;
